...
| `google-chrome-stable` | 150.0.7871.128 | 🅑 | ahead of nonguix; real `.deb` hash |
...
| **google-chrome-stable** | 150.0.7871.128 | 148.0.7778.215 (nonguix) | dl.google.com `.deb` |
