...
;;; librewolf — bumped ahead of Guix: 151.0.4-1 -> 153.0.4-1.  The real bump
...
;;;    Linux x86_64 portable binary (151.0.7922.173-1), hosted on GitHub
...
;;;    => Chromium 151.0.7922.173.  This is the recommended chromium on PATH.
(define-public ungoogled-chromium cr:ungoogled-chromium)
(define-public ungoogled-chromium-bin scr:ungoogled-chromium-bin)

;;; google-chrome — bumped ahead of nonguix: 148.0.7778.215 -> 152.0.7977.64
...
;;; Hash: `guix download .../google-chrome-stable_152.0.7977.64-1_amd64.deb'.
